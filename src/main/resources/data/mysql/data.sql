...
#INSERT INTO jai_hind.article (ARTICLE_CONTENT, ARTICLE_NAME, ARTICLE_PUBLISHED, ARTICLE_CREATED, USER_ID, PUBLISHED_DATE)
 # VALUE ('ArticleContent1', 'ArticleName1', 1, now(), 1, null);
#INSERT INTO jai_hind.article (ARTICLE_CONTENT, ARTICLE_NAME, ARTICLE_PUBLISHED, ARTICLE_CREATED, USER_ID, PUBLISHED_DATE)
 # VALUE ('ArticleContent2', 'ArticleName2', 1, now(), 1, null);
